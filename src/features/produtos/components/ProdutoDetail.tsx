...
import { ProdutosCatalogSection } from "./ProdutosCatalogSection";
  ...
  return (
    <main className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-12 gap-0">
              <div className="col-span-12 md:col-span-7 border-b md:border-b-0 md:border-r border-black">
                <div className="relative aspect-[4/3] w-full bg-neutral-50">
                  <Image src={produto.image} alt={p.title} fill sizes="(min-width: 768px) 50vw, 100vw" className="object-contain p-12 md:p-16" priority />
                </div>
              </div>
              <div className="col-span-12 md:col-span-5">
                <div className="flex flex-col justify-center h-full p-8 md:p-12">
                  <div className="mb-8">
                    <span className="inline-block bg-brand-red-500 text-white text-[10px] font-bold uppercase tracking-[0.2em] px-4 py-2 mb-6">{t.automec}</span>
                  ...
                  <div className="border-t border-black pt-8">
                    ...
                    <a href="#especificacao" className="inline-flex items-center gap-2 mt-4 text-[10px] font-bold uppercase tracking-[0.2em] text-brand-red-500 hover:text-brand-red-700 transition-colors">
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            <div className="grid grid-cols-12 gap-0 border-b border-black">
              ...
              <div className="col-span-12 md:col-span-8 p-8 md:p-12">
                <div className="text-base leading-[1.8] text-neutral-700 whitespace-pre-line">{p.description}</div>
              </div>
            </div>
          </div>
        </section>
      ...
      <FadeIn direction="up" delay={0.2}>
        <ProdutosCatalogSection dictionary={dictionary} catalog={p.catalog} />
      </FadeIn>
      ...
      <FadeIn direction="up" delay={0.15}>
        <ProdutosRelatedModels dictionary={dictionary} categoryLabel={p.relatedCategoryLabel} categoryHref={produto.relatedCategoryHref} />
      </FadeIn>
    </main>
  );
}
